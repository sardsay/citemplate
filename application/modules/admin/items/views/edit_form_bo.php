  ...
  <div class="col-lg-12">
    <div class="widget-container fluid-height clearfix">
      ...
      <div class="widget-content padded">
        ...
        <?php foreach ($itemdata as $key => $item):?>
          ...
          <div class="form-group <?php echo (isset($error_form['txtworkingtime']))?'has-error':'';?>">
            ...
            <div class="col-md-7">
              <input class="form-control" name="txtworkingtime" id="txtworkingtime" placeholder="กรอกเวลาทำการ" type="text" value="<?php echo (isset($error_val['val_txtworkingtime']))?$error_val['val_txtworkingtime']:$item->working_time;?>">
            </div>
          </div>
      ...
      <div id="temp-data" style="display:none;">
        <div class="widget-content padded">
          <form action="#" class="form-horizontal" name="editform" method="POST" enctype="multipart/form-data">
          <?php foreach ($itemTempData as $key => $item):?>
            <div class="form-group <?php echo (isset($error_form['ddcategory']))?'has-error':'';?>">
              <label class="control-label col-md-2">หมวดหมู่:*</label>
              <div class="col-md-7">
              <select class="form-control" name="ddcategory" id="ddcategory" disabled="disabled">
                <option value="0">กรุณาเลือกหมวดหมู่หลัก</option>
                  <?php foreach ($ddcategory as $cvalue):?>
                      <option value="<?php echo $cvalue->id;?>" <?php echo  ($cvalue->id == $item->category_id)?'selected="selected"':'';?>><?php echo $cvalue->name;?></option>
                  <?php endforeach;unset($cvalue);?>
                </select>
              </div>
            </div>
            <div class="form-group <?php echo (isset($error_form['ddcategory']))?'has-error':'';?>">
                        ...
                        <select class="form-control" name="ddsubcategory" id="ddsubcategory" disabled="disabled">
                          <option value="0">กรุณาเลือกหมวดหมู่ย่อย</option>
                            <?php foreach ($ddsubcategory as $cvalue):?>
                                <option value="<?php echo $cvalue->id;?>" <?php echo ($cvalue->id == $item->subcategory_id)?'selected="selected"':'';?>><?php echo $cvalue->name;?></option>
                            <?php endforeach;?>
                          </select>
            ...
            <div class="form-group <?php echo (isset($error_form['txttitle']))?'has-error':'';?>">
              <label class="control-label col-md-2">ชื่อสถานที่:*</label>
              <div class="col-md-7">
                <input class="form-control" disabled="disabled" name="txttitle" id="txttitle" placeholder="กรอกชื่อสถานที่" type="text" value="<?php echo (isset($error_val['val_txttitle']))?$error_val['val_txttitle']:$item->title;?>">
              </div>
            </div>
            <div class="form-group <?php echo (isset($error_form['txtareaaddress']))?'has-error':'';?>">
              <label class="control-label col-md-2">ที่อยู่:</label>
              <div class="col-md-7">
                  <textarea class="form-control" disabled="disabled" rows="3" name="txtareaaddress" id="txtareaaddress"><?php echo (isset($error_val['val_txtareaaddress']))?$error_val['val_txtareaaddress']:$item->address;?></textarea>
            ...
            <div class="form-group <?php echo (isset($error_form['txttelephone']))?'has-error':'';?>">
              <label class="control-label col-md-2">เบอร์โทรศัพท์:</label>
              <div class="col-md-7">
                <input class="form-control" disabled="disabled" name="txttelephone" id="txttelephone" placeholder="กรอกเบอร์โทรศัพท์" type="text" value="<?php echo (isset($error_val['val_txttelephone']))?$error_val['val_txttelephone']:$item->telephone;?>">
              </div>
            </div>
            <div class="form-group <?php echo (isset($error_form['txtwebsite']))?'has-error':'';?>">
              <label class="control-label col-md-2">เว็บไซต์:</label>
              <div class="col-md-7">
                <input class="form-control" disabled="disabled" name="txtwebsite" id="txtwebsite" placeholder="กรอกเว็บไซต์, เฟสบุ๊ค หรืออีเมล์" type="text" value="<?php echo (isset($error_val['val_txtwebsite']))?$error_val['val_txtwebsite']:$item->website;?>">
              </div>
            </div>
            <div class="form-group <?php echo (isset($error_form['txtworkingtime']))?'has-error':'';?>">
              <label class="control-label col-md-2">เวลาทำการ:</label>
              <div class="col-md-7">
                <input class="form-control" disabled="disabled" name="txtworkingtime" id="txtworkingtime" placeholder="กรอกเวลาทำการ" type="text" value="<?php echo (isset($error_val['val_txtworkingtime']))?$error_val['val_txtworkingtime']:$item->working_time;?>">
              </div>
            </div>
            <div class="form-group <?php echo (isset($error_form['txtareadescription']))?'has-error':'';?>">
              <label class="control-label col-md-2">รายละเอียด:</label>
              <div class="col-md-7">
                  <textarea class="form-control" disabled="disabled" rows="10"  name="txtareadescription" id="txtareadescription"><?php echo (isset($error_val['val_txtareadescription']))?$error_val['val_txtareadescription']:$item->description;?></textarea>
              </div>
            </div>
            <div class="form-group <?php echo (isset($error_form['txtlatitude']))?'has-error':'';?>">
              <label class="control-label col-md-2">ละติจูด:*</label>
              <div class="col-md-7">
                <input class="form-control" disabled="disabled" name="txtlatitude" id="txtlatitude" placeholder="กรอกละติจูด" type="text" value="<?php echo (isset($error_val['val_txtlatitude']))?$error_val['val_txtlatitude']:$item->latitude;?>">
              </div>
            </div>
            <div class="form-group <?php echo (isset($error_form['txtlongitude']))?'has-error':'';?>">
              <label class="control-label col-md-2">ลองจิจูด:*</label>
              <div class="col-md-7">
                <input class="form-control" disabled="disabled" name="txtlongitude" id="txtlongitude" placeholder="กรอกลองจิจูด" type="text" value="<?php echo (isset($error_val['val_txtlongitude']))?$error_val['val_txtlongitude']:$item->longitude;?>">
              </div>
            </div>
            <div class="form-group <?php echo (isset($error_form['ddlang']))?'has-error':'';?>">
              <label class="control-label col-md-2">ภาษา:*</label>
            ...
            <div class="form-group <?php echo (isset($error_form['image_thumb']))?'has-error':'';?>">
              <label class="control-label col-md-2"></label>
              <?php foreach ($galleryTemp2 as $key => $value):?>
                <div class="col-md-2" id="gall<?php echo $value->id;?>">
                  <img src="<?php echo base_url().URLPATH_UPLOAD_ITEMIMAGES.($item->id%10).'/'.$item->id.'/gallerys/'.$value->image_name;?>" width="200" height="150">
            ...
            <div class="form-group">
              <label class="control-label col-md-2">สถานะ</label>
              <div class="col-md-7">
                <?php echo ($item->status ==0)?'ไม่ใช้งาน':'ใช้งาน';?>
