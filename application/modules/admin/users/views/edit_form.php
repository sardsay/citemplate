...
<div class="row">
  <div class="col-lg-12">
    <div class="widget-container fluid-height clearfix">
      <div class="heading">
        <i class="fa fa-bars"></i>แก้ไขชื่อผู้ใช้งาน
      </div>
      <div class="widget-content padded">
        ...
        <?php foreach ($userdata as $key => $item):?>
          <div class="form-group <?php echo (isset($error_form['txtname']))?'has-error':'';?>">
            ...
            <div class="col-md-7">
              <input class="form-control" name="txtname" id="txtname" placeholder="ชื่อ" type="text" value="<?php echo (isset($error_val['val_txtname']))?$error_val['val_txtname']:$item->name;?>">
            </div>
          </div>
          <div class="form-group <?php echo (isset($error_form['txtrealname']))?'has-error':'';?>">
            <label class="control-label col-md-2">ชื่อจริง:*</label>
            <div class="col-md-7">
              <input class="form-control" name="txtrealname" id="txtrealname" placeholder="ชื่อจริง" type="text" value="<?php echo (isset($error_val['val_txtrealname']))?$error_val['val_txtrealname']:$item->realname;?>">
            </div>
          </div>
          <div class="form-group <?php echo (isset($error_form['txtusername']))?'has-error':'';?>">
            <label class="control-label col-md-2">Username:*</label>
            <div class="col-md-7">
              <input class="form-control" name="txtusername" id="txtusername" placeholder="Username" type="text" value="<?php echo (isset($error_val['val_txtusername']))?$error_val['val_txtusername']:$item->username;?>">
            </div>
          </div>
          ...
          <div class="form-group <?php echo (isset($error_form['txtareaaddress']))?'has-error':'';?>">
            ...
            <div class="col-md-7">
            <textarea class="form-control"name="txtareaaddress" id="txtareaaddress" rows="3"><?php echo (isset($error_val['val_txtareaaddress']))?$error_val['val_txtareaaddress']:$item->address;?></textarea>
          ...
          <div class="form-group <?php echo (isset($error_form['txtphone']))?'has-error':'';?>">
            ...
            <div class="col-md-7">
              <input class="form-control" name="txtphone" id="txtphone" placeholder="เบอร์โทรศัพท์" type="phone" value="<?php echo (isset($error_val['val_txtphone']))?$error_val['val_txtphone']:$item->phone;?>">
            </div>
          </div>
          <div class="form-group <?php echo (isset($error_form['txtemail']))?'has-error':'';?>">
            <label class="control-label col-md-2">อีเมล์:</label>
            <div class="col-md-7">
              <input class="form-control" name="txtemail" id="txtemail" placeholder="อีเมล์" type="email" value="<?php echo (isset($error_val['val_txtemail']))?$error_val['val_txtemail']:$item->email;?>">
            </div>
          </div>
            ...
            <select class="form-control" name="ddgroups" id="ddgroups">
              ...
              <option value="0">กรุณาเลือกกลุ่ม</option>
                <?php foreach ($ddgroups as $cvalue):?>
                    <option value="<?php echo $cvalue->id;?>" <?php echo ((isset($error_val['val_ddcategory'])&& $error_val['val_ddcategory']==$cvalue->id)|| $item->group_id== $cvalue->id)?'selected="selected"':'';?>><?php echo $cvalue->name;?></option>
                <?php endforeach;?>
              </select>
