...
<div class="row">
  <div class="col-lg-12">
    <div class="widget-container fluid-height clearfix">
      <div class="heading">
        <i class="fa fa-bars"></i>จัดการข้อมูลสถานที่อัพเดทจากแอพพลิเคชั่น 
      ...
      <div class="widget-content padded">
        ...
        <?php foreach ($itemdata as $key => $item):?>
          ...
          <?php if ($gallery1Delete != ''):?>
          <div class="form-group <?php echo (isset($error_form['image_thumb']))?'has-error':'';?>">
            <label class="control-label col-md-2"> รูปที่ต้องการลบ</label>
            <?php foreach ($gallery1Delete as $key => $value):?>
          ...
          <?php endif;?>
          <?php if ($gallery2Delete != ''):?>
          <div class="form-group <?php echo (isset($error_form['image_thumb']))?'has-error':'';?>">
            <label class="control-label col-md-2">รูปที่ต้องการลบ</label>
            <?php foreach ($gallery2Delete as $key => $value):?>
          ...
          <?php if($gallery1 != ''):?>
          <div class="form-group <?php echo (isset($error_form['image_thumb']))?'has-error':'';?>">
            <label class="control-label col-md-2">รูปที่ต้องการเพิ่ม</label>
        ...
        <?php endif;?>
          <div class="form-group">
            ...
            <?php elseif($item->status == 4):?>
              <label class="radio-inline"><input name="rdstatus" type="radio" value="5" <?php echo ((isset($error_val['val_rdstatus'])&&$error_val['val_rdstatus']==5) || $item->status == 5)?'checked="checked"':'';?>><span>ลบสถานที่</span></label>
              <label class="radio-inline"><input name="rdstatus" type="radio" value="3" <?php echo ((isset($error_val['val_rdstatus'])&&$error_val['val_rdstatus']==3)|| $item->status == 3)?'checked="checked"':'';?>><span>ปฏิเสธการคำขอ</span></label>
            <?php endif;?>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-7">
              ...
              <button class="btn btn-primary" type="submit">บันทึก</button><a href="<?php echo base_url().'items_mobile/update_index';?>"><button class="btn btn-default-outline" type="button">ยกเลิก</button></a>
            </div>
          </div>
        <?php endforeach;?>
        </form>
