          ...
          <!-- <div class="form-group">
            ...
            <div class="col-md-5">
              <select class="form-control" name="ddsource" id="ddsource">
                ...
                <option value="2" <?php echo ($this->input->get('ddsource')==2)?'selected="selected"':'';?>>shop</option>
                    ...
                    <tr>
                      ...
                      <td class="hidden-xs">
                        ...
                        <span class="label label-success">ใช้งาน</span>
                          ...
                          <span class="label label-danger">รอการตรวจสอบ</span>
                          <?php endif;?>
                          
                      </td>
                        <td>
                            <a href="<?php echo base_url().'items_mobile/editnew/'.$item->id;?>"> แก้ไข</a>
                      </td>
                    </tr>
                    <?php endforeach;?>
                  </tbody>
...
$(document).ready(function() {
    ...
    $("#txtsearch").typeahead({
        remote:{
          url: '<?php echo base_url();?>items_mobile/get_AutocompleteNew?keyword=%QUERY'
        }
