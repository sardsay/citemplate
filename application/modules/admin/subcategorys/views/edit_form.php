...
<div class="row">
  <div class="col-lg-12">
    <div class="widget-container fluid-height clearfix">
      <div class="heading">
        <i class="fa fa-bars"></i>แก้ไขหมวดหมู่ย่อย
      </div>
            ...
            <div class="col-md-7">
              <select class="form-control" name="ddmaincategory" id="ddmaincategory">
                ...
                <?php foreach ($mainCategorys as $key => $mcvalue):?>
                  <option value="<?php echo $mcvalue->id;?>" <?php echo ($item->parent_id==$mcvalue->id)?'selected="selected"':'';?>><?php echo $mcvalue->name;?></option>
                <?php endforeach;?>
              </select>
            </div>
          </div>
            ...
            <label> * แนะนำให้อัพโหลดรูปแนวตั้ง ขนาดขั้นตำ่ 300 x 400 px</label>
              <div class="fileupload fileupload-new" data-provides="fileupload">
                <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                  <img src="<?php echo base_url().URLPATH_UPLOAD_SUBCATEIMAGES.$item->id.'/'.$item->image_thumb_vertical;?>">
                </div>
