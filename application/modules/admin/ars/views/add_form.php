      ...
      <div class="widget-content padded">
        <form action="#" class="form-horizontal" name="addform" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group <?php echo (isset($error_form['txtar_name']))?'has-error':'';?>">
            ...
            <div class="col-md-7">
              <input class="form-control" name="txtar_name" id="txtar_name" placeholder="กรอกชื่อเออาร์" type="text" value="<?php echo (isset($error_val['val_txtar_name']))?$error_val['val_txtar_name']:'';?>">
            </div>
          </div>
          ...
          <div class="form-group <?php echo (isset($error_form['txtyoutube']))?'has-error':'';?>">
            ...
            <div class="col-md-7">
              <input class="form-control" name="txtyoutube" id="txtyoutube" placeholder="กรอก url จาก youtube" type="text" value="<?php echo (isset($error_val['val_txtyoutube']))?$error_val['val_txtyoutube']:'';?>">
            </div>
          </div>
