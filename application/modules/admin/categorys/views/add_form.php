...
<div class="row">
  <div class="col-lg-12">
    <div class="widget-container fluid-height clearfix">
      <div class="heading">
        <i class="fa fa-bars"></i>เพิ่มหมวดหมู่
      </div>
      <div class="widget-content padded">
        <form action="#" class="form-horizontal" name="addform" method="POST" enctype="multipart/form-data">
          ...
          <?php 
              if (!isset($error_val['val_rdshowmain'])) {
                $error_val['val_rdshowmain'] =1;  
              }
            ?>
            <!-- <div class="form-group">
            <label class="control-label col-md-2">แสดงหน้าหลัก</label>
            <div class="col-md-7">
              <label class="radio-inline">
                  <input name="rdshowmain" type="radio" value="1" <?php echo ($error_val['val_rdshowmain']==1)?'checked="checked"':'';?>><span>แสดง</span>
              </label>
                <label class="radio-inline"><input  name="rdshowmain" type="radio" value="0" <?php echo ($error_val['val_rdshowmain']==0)?'checked="checked"':'';?>><span>ไม่แสดง</span>
                </label>
            </div>
          </div> -->
          <div class="form-group">
